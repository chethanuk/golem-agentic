...
impl crate::bindings::exports::golem::agent::guest::GuestAgent for Agent {
    ...
    fn invoke(
        ...
        crate::internal::async_exported_function(async move {
            let result: crate::bindings::golem::agent::common::StatusUpdate = crate::internal::call_js_resource_method(
                    "golem:agent",
                    &["guest", "Agent"],
                    self.resource_id,
                    "invoke",
...
impl crate::bindings::exports::golem::agent::guest::Guest for Component {
    ...
    fn get_agent(
        agent_id: String,
    ) -> crate::bindings::exports::golem::agent::guest::AgentRef {
        crate::internal::async_exported_function(async move {
            let result: crate::bindings::exports::golem::agent::guest::AgentRef = crate::internal::call_js_export(
                    "golem:agent",
                    &["guest", "getAgent"],
                    (agent_id,),
                )
    ...
    fn discover_agents() -> Vec<
        crate::bindings::exports::golem::agent::guest::AgentRef,
    > {
        crate::internal::async_exported_function(async move {
            let result: Vec<crate::bindings::exports::golem::agent::guest::AgentRef> = crate::internal::call_js_export(
                    "golem:agent",
