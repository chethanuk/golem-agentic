    ...
    fn into_js(
        ...
        match self {
            crate::bindings::golem::rpc::types::WitTypeNode::RecordType(inner) => {
                ...
                let case_value: Vec<
                    rquickjs::convert::List<
                        (String, crate::bindings::golem::rpc::types::NodeIndex),
                    >,
                > = inner
                    .into_iter()
            ...
            crate::bindings::golem::rpc::types::WitTypeNode::VariantType(inner) => {
                ...
                let case_value: Vec<
                    rquickjs::convert::List<
                        (String, Option<crate::bindings::golem::rpc::types::NodeIndex>),
                    >,
                > = inner
                    .into_iter()
                    .map(|v| rquickjs::convert::List(v))
    ...
    fn from_js(
        ...
        match tag.as_str() {
            ...
            "result-type" => {
                ...
                > = obj.get(crate::wrappers::VALUE)?;
                Ok(crate::bindings::golem::rpc::types::WitTypeNode::ResultType(inner.0))
            }
            "prim-u8-type" => {
            ...
            "handle-type" => {
                ...
                > = obj.get(crate::wrappers::VALUE)?;
                Ok(crate::bindings::golem::rpc::types::WitTypeNode::HandleType(inner.0))
            }
            _ => {
                Err(
                    rquickjs::Error::new_from_js_message(
...
impl<'js> rquickjs::IntoJs<'js> for crate::bindings::golem::rpc::types::WitType {
    fn into_js(
        ...
        let obj = rquickjs::Object::new(ctx.clone())?;
        let nodes: Vec<crate::bindings::golem::rpc::types::WitTypeNode> = self
            .nodes
            .into_iter()
            .map(|v| v)
            .collect::<Vec<_>>();
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::rpc::types::WitType {
    fn from_js(
        ...
        let obj = rquickjs::Object::from_value(value)?;
        let nodes: Vec<crate::bindings::golem::rpc::types::WitTypeNode> = obj
            .get("nodes")?;
        let nodes: Vec<crate::bindings::golem::rpc::types::WitTypeNode> = nodes
            .into_iter()
            .map(|v| v)
            .collect::<Vec<_>>();
        Ok(Self { nodes })
    ...
    fn into_js(
        ...
        match self {
            ...
            crate::bindings::golem::rpc::types::WitNode::VariantValue(inner) => {
                ...
                let case_value: rquickjs::convert::List<
                    (u32, Option<crate::bindings::golem::rpc::types::NodeIndex>),
                > = rquickjs::convert::List(inner);
                obj.set(crate::wrappers::VALUE, case_value)?;
            }
            ...
            crate::bindings::golem::rpc::types::WitNode::Handle(inner) => {
                ...
                let case_value: rquickjs::convert::List<
                    (crate::bindings::golem::rpc::types::Uri, u64),
                > = rquickjs::convert::List(inner);
                obj.set(crate::wrappers::VALUE, case_value)?;
            }
        }
        ...
        match tag.as_str() {
            ...
            "variant-value" => {
                let inner: rquickjs::convert::List<
                    (u32, Option<crate::bindings::golem::rpc::types::NodeIndex>),
                > = obj.get(crate::wrappers::VALUE)?;
                Ok(crate::bindings::golem::rpc::types::WitNode::VariantValue(inner.0))
            }
            "enum-value" => {
...
for crate::bindings::golem::agent::common::ParameterType {
    fn into_js(
        self,
        ctx: &rquickjs::Ctx<'js>,
    ) -> rquickjs::Result<rquickjs::Value<'js>> {
        ...
        match tag.as_str() {
            "wit" => {
                let inner: crate::bindings::golem::rpc::types::WitType = obj
                    .get(crate::wrappers::VALUE)?;
                Ok(crate::bindings::golem::agent::common::ParameterType::Wit(inner))
            }
            "text" => {
                let inner: crate::bindings::golem::agent::common::TextType = obj
                    .get(crate::wrappers::VALUE)?;
                Ok(crate::bindings::golem::agent::common::ParameterType::Text(inner))
            }
            _ => {
                Err(
                    rquickjs::Error::new_from_js_message(
...
impl<'js> rquickjs::IntoJs<'js> for crate::bindings::golem::agent::common::Structured {
    fn into_js(
        ...
        let obj = rquickjs::Object::new(ctx.clone())?;
        let parameters: Vec<crate::bindings::golem::agent::common::ParameterType> = self
            .parameters
            .into_iter()
            .map(|v| v)
            .collect::<Vec<_>>();
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::agent::common::Structured {
    fn from_js(
        ...
        let obj = rquickjs::Object::from_value(value)?;
        let parameters: Vec<crate::bindings::golem::agent::common::ParameterType> = obj
            .get("parameters")?;
        let parameters: Vec<crate::bindings::golem::agent::common::ParameterType> = parameters
            .into_iter()
            .map(|v| v)
            .collect::<Vec<_>>();
        Ok(Self { parameters })
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::agent::common::Multimodal {
    fn from_js(
        ...
        let obj = rquickjs::Object::from_value(value)?;
        let text: Option<Vec<crate::bindings::golem::agent::common::TextType>> = obj
            .get("text")?;
        let text: Option<Vec<crate::bindings::golem::agent::common::TextType>> = text
            .map(|v| v.into_iter().map(|v| v).collect::<Vec<_>>());
        Ok(Self { text })
    }
}
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::agent::common::DataSchema {
    fn from_js(
        ...
        match tag.as_str() {
            "structured" => {
                let inner: crate::bindings::golem::agent::common::Structured = obj
                    .get(crate::wrappers::VALUE)?;
                Ok(crate::bindings::golem::agent::common::DataSchema::Structured(inner))
            }
            "multimodal" => {
                let inner: crate::bindings::golem::agent::common::Multimodal = obj
                    .get(crate::wrappers::VALUE)?;
...
impl<'js> rquickjs::IntoJs<'js> for crate::bindings::golem::agent::common::AgentType {
    fn into_js(
        ...
        let description: String = self.description;
        obj.set("description", description)?;
        let agent_constructor: crate::bindings::golem::agent::common::AgentConstructor = self
            .agent_constructor;
        ...
        let methods: Vec<crate::bindings::golem::agent::common::AgentMethod> = self
            ...
            .collect::<Vec<_>>();
        obj.set("methods", methods)?;
        let requires: Vec<crate::bindings::golem::agent::common::AgentDependency> = self
            .requires
            .into_iter()
            .map(|v| v)
            .collect::<Vec<_>>();
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::agent::common::AgentType {
    fn from_js(
        ...
        let description: String = obj.get("description")?;
        let description: String = description;
        let agent_constructor: crate::bindings::golem::agent::common::AgentConstructor = obj
            .get("agentConstructor")?;
        let agent_constructor: crate::bindings::golem::agent::common::AgentConstructor = agent_constructor;
        let methods: Vec<crate::bindings::golem::agent::common::AgentMethod> = obj
            .get("methods")?;
        let methods: Vec<crate::bindings::golem::agent::common::AgentMethod> = methods
            .into_iter()
            .map(|v| v)
            .collect::<Vec<_>>();
        let requires: Vec<crate::bindings::golem::agent::common::AgentDependency> = obj
            .get("requires")?;
        let requires: Vec<crate::bindings::golem::agent::common::AgentDependency> = requires
            .into_iter()
            .map(|v| v)
            .collect::<Vec<_>>();
        Ok(Self {
...
impl<'js> rquickjs::IntoJs<'js>
for crate::bindings::golem::agent::common::ProgressCounter {
    fn into_js(
        self,
        ctx: &rquickjs::Ctx<'js>,
    ) -> rquickjs::Result<rquickjs::Value<'js>> {
...
impl<'js> rquickjs::IntoJs<'js>
for crate::bindings::golem::agent::common::ProgressReport {
    fn into_js(
        self,
        ctx: &rquickjs::Ctx<'js>,
    ) -> rquickjs::Result<rquickjs::Value<'js>> {
        ...
        let description: String = self.description;
        obj.set("description", description)?;
        let counter: Option<crate::bindings::golem::agent::common::ProgressCounter> = self
            .counter
            .map(|v| v);
...
for crate::bindings::golem::agent::common::ProgressReport {
    fn from_js(
        ...
        let description: String = obj.get("description")?;
        let description: String = description;
        let counter: Option<crate::bindings::golem::agent::common::ProgressCounter> = obj
            .get("counter")?;
        let counter: Option<crate::bindings::golem::agent::common::ProgressCounter> = counter
            .map(|v| v);
        Ok(Self { description, counter })
    }
}
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::agent::common::Error {
    fn from_js(
        ...
        match tag.as_str() {
            "network-error" => {
                Ok(crate::bindings::golem::agent::common::Error::NetworkError)
            }
            _ => {
                Err(
                    rquickjs::Error::new_from_js_message(
    ...
    fn into_js(
        ...
        match self {
            ...
            crate::bindings::golem::agent::common::StatusUpdate::Progress(inner) => {
                ...
                let case_value: Option<
                    crate::bindings::golem::agent::common::ProgressReport,
                > = inner.map(|v| v);
                obj.set(crate::wrappers::VALUE, case_value)?;
            }
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::agent::common::StatusUpdate {
    fn from_js(
        ...
        match tag.as_str() {
            "error" => {
                let inner: crate::bindings::golem::agent::common::Error = obj
                    .get(crate::wrappers::VALUE)?;
                Ok(crate::bindings::golem::agent::common::StatusUpdate::Error(inner))
            }
            "progress" => {
                let inner: Option<
                    crate::bindings::golem::agent::common::ProgressReport,
                > = obj.get(crate::wrappers::VALUE)?;
                Ok(
                    crate::bindings::golem::agent::common::StatusUpdate::Progress(
                        inner.map(|v| v),
                    ),
                )
            }
            "emit" => {
                let inner: String = obj.get(crate::wrappers::VALUE)?;
                Ok(crate::bindings::golem::agent::common::StatusUpdate::Emit(inner))
            }
            _ => {
                Err(
                    rquickjs::Error::new_from_js_message(
...
impl<'js> rquickjs::IntoJs<'js>
for crate::bindings::exports::golem::agent::guest::AgentRef {
    fn into_js(
        self,
        ctx: &rquickjs::Ctx<'js>,
    ) -> rquickjs::Result<rquickjs::Value<'js>> {
