  ...
  return function(BaseClass) {
    ...
    return class extends BaseClass {
      constructor(...args) {
        ...
        const methodNames = Object.getOwnPropertyNames(concreteClass.prototype).filter((m) => m !== "constructor" && typeof concreteClass.prototype[m] === "function");
        const methods = methodNames.map((methodName) => {
          ...
          return {
            ...
            promptHint: baseMeta.prompt ?? void 0,
