...
declare function AgentDefinition<T extends abstract new (...args: any[]) => any>(name?: string): (BaseClass: T) => T;
declare function AgentImplementation(): <T extends new (...args: any[]) => any>(ctor: T) => void;
...
export { Agent, AgentDefinition, AgentImplementation, Description, Prompt, agentRegistry, getRegisteredAgents, guest };
