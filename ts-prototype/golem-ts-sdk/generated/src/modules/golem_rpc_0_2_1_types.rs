...
fn parse_uuid(
    ...
    let result: Result<crate::bindings::golem::rpc::types::Uuid, String> =
        crate::bindings::golem::rpc::types::parse_uuid(uuid.as_str());
    crate::wrappers::JsResult(match result {
        Ok(v) => Ok(v),
        Err(v) => Err(v),
    })
}
...
fn extract_value(
    ...
    let result: crate::bindings::golem::rpc::types::WitValue =
        crate::bindings::golem::rpc::types::extract_value(&vnt);
    result
}
#[rquickjs::function]
fn extract_type(
    ...
    let result: crate::bindings::golem::rpc::types::WitType =
        crate::bindings::golem::rpc::types::extract_type(&vnt);
    result
}
...
impl WasmRpc {
    ...
    pub fn ephemeral(
        ...
        let result: crate::bindings::golem::rpc::types::WasmRpc =
            crate::bindings::golem::rpc::types::WasmRpc::ephemeral(component_id);
        result
    }
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::rpc::types::WasmRpc {
    fn from_js(ctx: &rquickjs::Ctx<'js>, value: rquickjs::Value<'js>) -> rquickjs::Result<Self> {
        ...
        unsafe {
            Ok(crate::bindings::golem::rpc::types::WasmRpc::from_handle(
                wrapper
                    .inner
...
impl FutureInvokeResult {
    ...
    > {
        ...
        > = self
            ...
            .get();
        result.map(|v| {
            crate::wrappers::JsResult(match v {
                Ok(v) => Ok(v),
                Err(v) => Err(v),
            })
        })
...
impl<'js> rquickjs::IntoJs<'js> for crate::bindings::golem::rpc::types::FutureInvokeResult {
    fn into_js(self, ctx: &rquickjs::Ctx<'js>) -> rquickjs::Result<rquickjs::Value<'js>> {
        FutureInvokeResult {
            inner: Some(std::rc::Rc::new(self)),
        }
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::rpc::types::FutureInvokeResult {
    fn from_js(ctx: &rquickjs::Ctx<'js>, value: rquickjs::Value<'js>) -> rquickjs::Result<Self> {
...
impl<'js> rquickjs::FromJs<'js> for BorrowFutureInvokeResultWrapper {
    fn from_js(ctx: &rquickjs::Ctx<'js>, value: rquickjs::Value<'js>) -> rquickjs::Result<Self> {
        let wrapper = FutureInvokeResult::from_js(ctx, value)?;
        unsafe {
            Ok(BorrowFutureInvokeResultWrapper(
                crate::bindings::golem::rpc::types::FutureInvokeResult::from_handle(
                    wrapper
                        .inner
                        .ok_or_else(|| rquickjs::Error::FromJs {
...
impl<'js> rquickjs::IntoJs<'js> for crate::bindings::golem::rpc::types::CancellationToken {
    fn into_js(self, ctx: &rquickjs::Ctx<'js>) -> rquickjs::Result<rquickjs::Value<'js>> {
        CancellationToken {
            inner: Some(std::rc::Rc::new(self)),
        }
...
impl<'js> rquickjs::FromJs<'js> for crate::bindings::golem::rpc::types::CancellationToken {
    fn from_js(ctx: &rquickjs::Ctx<'js>, value: rquickjs::Value<'js>) -> rquickjs::Result<Self> {
...
impl<'js> rquickjs::FromJs<'js> for BorrowCancellationTokenWrapper {
    fn from_js(ctx: &rquickjs::Ctx<'js>, value: rquickjs::Value<'js>) -> rquickjs::Result<Self> {
        let wrapper = CancellationToken::from_js(ctx, value)?;
        unsafe {
            Ok(BorrowCancellationTokenWrapper(
                crate::bindings::golem::rpc::types::CancellationToken::from_handle(
                    wrapper
                        .inner
                        .ok_or_else(|| rquickjs::Error::FromJs {
